...
@Component({
  ...
  templateUrl: './workflow-send.component.html',
  styleUrls: ['./workflow-send.component.css']
})
export class WorkflowSendComponent implements OnInit {
  @Input() InputParam;
  ...
  onOkClick() {
    ...
    if (!this.InputParam.IsWFShow) {
      ...
      if (this.InputParam.selectedRow && this.InputParam.selectedRow.data.WorkflowObjectCode === 1) {
        this.PopUptype = 'Cartable_contract_estimate';
        this.PopUpParams.WorkFlowID = this.SelectedRow.data.WorkFlowLogID;
        this.startLeftPosition = 1;
      ...
      if (this.InputParam.selectedRow && this.InputParam.selectedRow.data.WorkflowObjectCode === 2) {
        ...
        if (this.InputParam.CurrWorkFlow.ObjectTypeCode === 9 || this.InputParam.CurrWorkFlow.ObjectTypeCode === 10) { // پیش پرداخت و علی الحساب
          ...
          this.HeightPercentWithMaxBtn = 55;
      ...
      if (this.InputParam.selectedRow && this.InputParam.selectedRow.data.WorkflowObjectCode === 10) {
        this.PopUptype = 'pure-product-request-page';
        this.startLeftPosition = 110;
        this.startTopPosition = 5;
        this.HeightPercentWithMaxBtn = 97;
        this.MinHeightPixel = 645;
      }
      if (this.InputParam.selectedRow && this.InputParam.selectedRow.data.WorkflowObjectCode === 11) {
      ...
      if (this.InputParam.CurrWorkFlow.WorkflowObjectCode === 16) {
        this.PopUptype = 'fee-page';
        this.HeightPercentWithMaxBtn = 97;
        this.MinHeightPixel = 645;
        this.startLeftPosition = 59;
        this.startTopPosition = 20;
      }
      if (this.InputParam.selectedRow && this.InputParam.selectedRow.data.WorkflowObjectCode === 15) {
