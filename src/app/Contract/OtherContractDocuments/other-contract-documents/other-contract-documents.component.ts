...
@Component({
  ...
  templateUrl: './other-contract-documents.component.html',
  styleUrls: ['./other-contract-documents.component.css']
})
export class OtherContractDocumentsComponent implements OnInit {
  @Input() InputParam;
  ...
  onDisplay() {
    ...
    if (this.InputParam.IsViewable !== null) {
      this.DisplayControlls = !this.InputParam.IsViewable;
    }
  }
  ...
  EditModeNgInit() {
      ...
      if (res[1] && res[1][0]) {
        ...
        this.selectedContractAgentObj = res[1][0].ContractAgentCode;
  ...
  onChangeContractAgentObj(newObj) {
    this.selectedContractAgentObj = newObj;
